...
import com.amstech.balloon.decoration.system.service.BookingService;
...
private final Logger LOGGER = LoggerFactory.getLogger(BookingController.class);
	...
	public ResponseEntity<Object> create(@RequestBody BookingCreateRequestModal bookingCreateRequestModal){
		...
		LOGGER.info("Booking Create for Decoration with id  : {} " ,bookingCreateRequestModal.getDecorationId());
		try {
